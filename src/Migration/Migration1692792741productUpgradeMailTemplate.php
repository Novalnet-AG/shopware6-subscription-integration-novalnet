...
class Migration1692792741productUpgradeMailTemplate extends MigrationStep
{
    ...
    public function createProductChangeTemplate(Connection $connection): void
    {
        ...
        $mailTypeId = $this->getMailTypeMapping()['novalnet_product_upgrade_mail']['id'];
        $deLangId = $enLangId = '';
        ...
        if (!$this->checkMailType($connection)) {
            $connection->insert(
                ...
                'technical_name' => 'novalnet_product_upgrade_mail',
                'available_entities' => json_encode($this->getMailTypeMapping()['novalnet_product_upgrade_mail']['availableEntities']),
            ...
            if ($enLangId != '') {
                $connection->insert(
                    ...
                    [
                        ...
                        'subject' => 'The product quantity has been upgraded for your subscription order number {{ subs.subsNumber }}',
                        'description' => 'Subscription Product Upgrade Mail',
                ...
                $connection->insert(
                    ...
                    [
                        'mail_template_type_id' => Uuid::fromHexToBytes($mailTypeId),
                        'language_id' => Uuid::fromHexToBytes($enLangId),
                        'name' => 'Subscription Product Upgrade Mail',
                        'created_at' => (new \DateTime())->format(Defaults::STORAGE_DATE_TIME_FORMAT),
                    ]
                );
            }
            ...
            if ($deLangId != '') {
                $connection->insert(
                    ...
                    [
                        ...
                        'subject' => 'Die Produktmenge wurde für Ihre Abonnementbestellnummer erhöht {{ subs.subsNumber }}',
                        'description' => 'Abonnement Produkt-Upgrade-Mail',
                        'sender_name' => '{{ salesChannel.name }}',
                ...
                $connection->insert(
                    ...
                    [
                        'mail_template_type_id' => Uuid::fromHexToBytes($mailTypeId),
                        'language_id' => Uuid::fromHexToBytes($deLangId),
                        'name' => 'Abonnement Produkt-Upgrade-Mail',
                        'created_at' => (new \DateTime())->format(Defaults::STORAGE_DATE_TIME_FORMAT),
                    ]
                );
            }
    ...
    {
        return[
            'novalnet_product_upgrade_mail' => [
                'id' => Uuid::randomHex(),
                'name' => 'Subscription Product Upgrade Mail',
                'nameDe' => 'Abonnement Produkt-Upgrade-Mail',
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	<p>
		...
		<br>
		The product quantity has been upgraded for your subscription (Subscription Number: {{subs.subsNumber}}) from the shop {{ salesChannel.name }}.<br>
		<br>
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	<p>
		...
		{{order.orderCustomer.salutation.letterName }} {{order.orderCustomer.firstName}} {{order.orderCustomer.lastName}},<br>
		<br>
		Die Produktmenge wurde für Ihr Abonnement hochgestuft (Abonnementnummer: {{subs.subsNumber}}) aus dem Geschäft {{ salesChannel.name }}.<br>
		<br>
